...
contract SocialIntegrationTest is TestHelpers {
    ...
    function test_MakePredictionThenTrade() public {
        ...
        CategoricalMarket(market).buyShares(0, 0, 5000 * 1e18);
        vm.stopPrank();
    ...
    function test_LeaderboardWithTrading() public {
        ...
        for (uint256 i = 0; i < 2; i++) {
            ...
            CategoricalMarket(currentMarket).buyShares(0, 0, 5000 * 1e18);
            vm.stopPrank();
    ...
    function test_PredictionHistoryWithMultipleTrades() public {
        ...
        for (uint256 i = 0; i < 3; i++) {
            ...
            CategoricalMarket(market).buyShares(0, 0, 2000 * 1e18);
            vm.stopPrank();
        }
    ...
    function test_StreakWithCorrectTrades() public {
        ...
        for (uint256 i = 0; i < 5; i++) {
            ...
            CategoricalMarket(currentMarket).buyShares(0, 0, 3000 * 1e18);
            vm.stopPrank();
